...
public class AppMusic extends App {
	...
	EyeList songs;
	Map<SoundEvent, MusicDiscItem> discs = new HashMap<SoundEvent, MusicDiscItem>();
	...
	public AppMusic() {
		...
		discs.put(SoundEvents.MUSIC_DISC_11, (MusicDiscItem) Items.MUSIC_DISC_11);
		discs.put(SoundEvents.MUSIC_DISC_13, (MusicDiscItem) Items.MUSIC_DISC_13);
		discs.put(SoundEvents.MUSIC_DISC_BLOCKS, (MusicDiscItem) Items.MUSIC_DISC_BLOCKS);
		discs.put(SoundEvents.MUSIC_DISC_CAT, (MusicDiscItem) Items.MUSIC_DISC_CAT);
		discs.put(SoundEvents.MUSIC_DISC_CHIRP, (MusicDiscItem) Items.MUSIC_DISC_CHIRP);
		discs.put(SoundEvents.MUSIC_DISC_FAR, (MusicDiscItem) Items.MUSIC_DISC_FAR);
		discs.put(SoundEvents.MUSIC_DISC_MALL, (MusicDiscItem) Items.MUSIC_DISC_MALL);
		discs.put(SoundEvents.MUSIC_DISC_MELLOHI, (MusicDiscItem) Items.MUSIC_DISC_MELLOHI);
		//discs.put(SoundEvents.MUSIC_DISC_OTHERSIDE, (MusicDiscItem) Items.MUSIC_DISC_OTHERSIDE);
		discs.put(SoundEvents.MUSIC_DISC_PIGSTEP, (MusicDiscItem) Items.MUSIC_DISC_PIGSTEP);
		discs.put(SoundEvents.MUSIC_DISC_STAL, (MusicDiscItem) Items.MUSIC_DISC_STAL);
		discs.put(SoundEvents.MUSIC_DISC_STRAD, (MusicDiscItem) Items.MUSIC_DISC_STRAD);
		discs.put(SoundEvents.MUSIC_DISC_WAIT, (MusicDiscItem) Items.MUSIC_DISC_WAIT);
		discs.put(SoundEvents.MUSIC_DISC_WARD, (MusicDiscItem) Items.MUSIC_DISC_WARD);
	}
