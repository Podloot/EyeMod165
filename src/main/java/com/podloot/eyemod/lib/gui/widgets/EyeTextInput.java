...
public abstract class EyeTextInput extends EyeInteract {
	...
	public abstract void drawCursor(MatrixStack matrices, int x, int y);
	
	public abstract void drawLines(MatrixStack matrices, int x, int y);
	
	public abstract void drawSuggest(MatrixStack matrices, int x, int y, String s);
