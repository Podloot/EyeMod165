...
public class AppMessages extends App {
	...
	public void openChat(String user) {
		...
		ListNBT messages = this.getMessages().getList(user, Type.STRING.type);
	...
	public void refreshChat(ListNBT messages) {
	...
	public void deleteChat(String user) {
		CompoundNBT msgs = this.getMessages();
		msgs.remove(user);
		device.data.setCompoundNBT("messages", msgs);
	}
	...
	public CompoundNBT getMessages() {
	...
	public void tick(int mx, int my) {
		if(chat != null && currentUser != null) {
			ListNBT m = this.getMessages().getList(currentUser, Type.STRING.type);
