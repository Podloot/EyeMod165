...
public class GuiRouter extends EyeScreen {
	...
	public GuiRouter(Hand hand, Pos router, boolean canOpen) {
	...
	public String getRouterPassword() {
		if(router != null) {
			if(getUser().clientLevel.getBlockEntity(router.getPos()) instanceof RouterEntity) {
				return ((RouterEntity)getUser().clientLevel.getBlockEntity(router.getPos())).password;
			}
		}
		return "|";
	}
