...
public abstract class AppTextList extends App {
	...
	public abstract EyeWidget getMain(EyeBoxPanel box, int index, CompoundTag info);

	public abstract EyeWidget getExpendable(EyeBoxPanel box, int index, CompoundTag info);
